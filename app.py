...
alcohol_consumption = st.slider("Alcohol Consumption (From 0 - 30)", 0, 30, 2)
fruit_consumption = st.slider("Fruit Consumption (From 0 - 120)", 0, 120, 3)
green_vegetables = st.slider("Green Vegetables Consumption (From 0 - 128)", 0, 128, 3)
fried_potato = st.slider("Fried Potato Consumption (From 0 - 128)", 0, 128, 1)
